...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6982088057:AAHYUfdIOrLZSuF5W17frqCzijPY3uNeOgQ")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002479488316"))

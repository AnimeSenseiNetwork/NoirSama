...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "65B1UknJQC05lRCClE33-a010")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "https://t.me/money_dogs_bot/money_dogs?startapp=lTUZe1il"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001784672307"))

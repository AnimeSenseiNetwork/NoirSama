...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6813308007:AAHtF-twDXUs7layVW06s2eEoM_CONnO9Yk")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001984150663"))

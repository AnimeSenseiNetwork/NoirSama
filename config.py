...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6602960633:AAFc2aVPvUhXmK-1UifEf88LvpUwuszsIEg")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001856862537"))

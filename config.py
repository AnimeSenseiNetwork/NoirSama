...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6813308007:AAFaiW54yW6RSHbjsXJYTKM57olIfsBoJiQ")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002279161593"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1001867726203"))

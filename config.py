...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6602960633:AAEodfmw2Kg8kXOxs4yrJZdoboK4DxEJYnE")
...
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002031918628"))

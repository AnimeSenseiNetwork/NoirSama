...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6602960633:AAFaQlCmvpWROSEuMJCeRUlztd9bNGuTQPM")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002739298766"))

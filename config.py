...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6982088057:AAHsofA9GB5wF1hdrGpcELPfASwB4aihXa8")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002038620816"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002297828402"))

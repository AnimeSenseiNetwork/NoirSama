...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6602960633:AAEVXzZ_c9FxnhOnOWUHlSI4_h5LWOU4npU")
...
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002479488316"))

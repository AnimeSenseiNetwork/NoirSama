...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6813308007:AAF1oocozNijFNmQkyo9Pa7paMV90NmIGss")
...
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002348310546"))
